...
const songs = [
  ...
  },
  {
    ...
    musicians: [
      {
        name: "Vain Mainstream",
        instrument: ["vocals", "electric guitar", "acoustic guitar", "bass", "drums", "keyboards", "effects"],
      },
    ],
  },
  {
...
const artists = [
  {
    ...
    members: [
      {
        name: "Kevin Long",
        instrument: ["vocals", "acoustic guitar", "electric guitar", "trombone"],
      },
    ],
    number_of_saves: 0,
    city: "St. Louis",
...
releases.forEach((release) => {
  ...
  release.musicians = Array.from(musicianMap.entries()).map(([name, instrumentsSet]) => ({
    name,
