...
const users = [
  {
    ...
    saved_songs: [
      { title: "Last Night", artist: "The Long Emergency", release: "Starting Over" },
      { title: "Starting Over", artist: "The Long Emergency", release: "Starting Over" },
      { title: "Dragon Attack", artist: "Vain Mainstream", release: "Your Likeness" },
      { title: "Fake Plastic Trees", artist: "Vain Mainstream", release: "Your Likeness" },
    ],
    saved_releases: [
...
const releases = [
  {
    ...
    cover_img_file_key: "9Dk0lBirZ3pQRmATNsyhYPpStqRu432wBydgr7CUnWozmsj0",
    songs: [
      { title: "Fall", artist: "The Long Emergency", release: "I spent all my money on a habit" },
      { title: "I Am Not Sorry", artist: "The Long Emergency", release: "I spent all my money on a habit" },
      { title: "Snow Emergency", artist: "The Long Emergency", release: "I spent all my money on a habit" },
      { title: "Standing on a tree stump with a bunch of buttons in my hand", artist: "The Long Emergency", release: "I spent all my money on a habit" },
      { title: "Twist the Knife", artist: "The Long Emergency", release: "I spent all my money on a habit" },
      { title: "Last Night", artist: "The Long Emergency", release: "I spent all my money on a habit" },
      { title: "Like Breathing", artist: "The Long Emergency", release: "I spent all my money on a habit" },
    ],
    type: "album",
    number_of_saves: 0,
  },
  // ... (other releases, use {title, artist, release} for each song reference)
  {
    ...
    songs: [
      { title: "Last Night", artist: "The Long Emergency", release: "Starting Over" },
      { title: "Snow Emergency", artist: "The Long Emergency", release: "Starting Over" },
      { title: "I-35", artist: "The Long Emergency", release: "Starting Over" },
      { title: "I Am Not Sorry", artist: "The Long Emergency", release: "Starting Over" },
      { title: "Twist The Knife", artist: "The Long Emergency", release: "Starting Over" },
      { title: "Starting Over", artist: "The Long Emergency", release: "Starting Over" },
      { title: "Sing Me To Sleep", artist: "The Long Emergency", release: "Starting Over" },
    ],
    type: "album",
    number_of_saves: 0,
  },
  {
    ...
    songs: [
      { title: "Fake Plastic Trees", artist: "Vain Mainstream", release: "Your Likeness" },
      { title: "Dragon Attack", artist: "Vain Mainstream", release: "Your Likeness" },
      { title: "Number One", artist: "Vain Mainstream", release: "Your Likeness" },
    ],
    type: "album",
    number_of_saves: 0,
  },
...
const artists = [
  {
    ...
    releases: [
      { title: "Starting Over", artist: "The Long Emergency" },
      { title: "I spent all my money on a habit", artist: "The Long Emergency" },
    ],
    genre: ["Indie", "Rock"],
    members: ["Kevin Long"],
    number_of_saves: 0,
...
songs.forEach((song) => {
  song.artist = artistMap[song.artist];
  song.release = releaseMap[`${song.release}|${Object.keys(artistMap).find(name => artistMap[name] === song.artist)}`];
});
...
const playlists = [
  {
    ...
    songs: [
      ...
      { title: "Dragon Attack", artist: "Vain Mainstream", release: "Your Likeness" },
      { title: "Fake Plastic Trees", artist: "Vain Mainstream", release: "Your Likeness" },
    ].map(({ title, artist, release }) => songMap[`${title}|${artist}|${release}`]),
    public: true,
    created_by: users[0].id,
    number_of_saves: 1,
  },
...
users.forEach((user) => {
  ...
  user.saved_artists = user.saved_artists.map(
    ({ name }) => artistMap[name]
  );
  user.playlists = user.playlists.map(
    (title) => playlists.find((p) => p.title === title).id
